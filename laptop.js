 ...
 pickLaptop = () => {
    ...
    document.getElementById("laptopTitle").textContent 
     = (`${data[index].title}`)
    ...
    document.getElementById("laptopPrice").textContent 
    = formattedPrice;
    
    // Gets the element for the image of the laptop and adds the image of the currently selected laptop.
    document.getElementById("laptopImage").innerHTML = 
    `<img src="https://hickory-quilled-actress.glitch.me/${data[index].image}" 
